...
A utility for analyzing your Instagram follow data. Shows who doesn’t follow you back, who your fans are, and who is mutual.

## 🚀 Modes

### Mode 1 — TURBO (via browser)
Opens Chrome, you log into Instagram manually, and the program collects data in real time.

**Pros:** accurate data, deleted accounts won’t appear as “rats”  
**Cons:** requires Chrome, manual login, takes longer  

### Mode 2 — ARCHIVE (via Instagram .zip)
Reads your data archive that you request from Instagram settings.

**Pros:** fast, no browser needed, fully offline  
**Cons:** you need to request the archive in advance (wait 1–2 days), deleted accounts may appear as “rats”  
