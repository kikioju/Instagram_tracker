...
1. Инстаграм → Настройки → Конфиденциальность
2. Твои данные в Instagram → Скачать данные
3. Выбери формат **JSON** → Запроси файл
4. Через 1-2 дня Instagram пришлёт ссылку на почту
